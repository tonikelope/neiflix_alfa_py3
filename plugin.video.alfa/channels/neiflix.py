...
def leer_criticas_fa(item):
    ...
    for critica in criticas:
        ...
        itemlist.append(Item(channel=item.channel, nota_fa=fa_data[0], contentPlot="[I]Crítica de: "+(item.contentSerieName if item.mode == "tvshow" else item.contentTitle)+"[/I]", thumbnail=thumbnail, title=rating_text+" "+critica['title']+" ("+critica['nick']+")", action="cargar_critica", url=critica['url'], critica_title="["+critica['nota']+"] "+critica['title']+" ("+critica['nick']+")"))
